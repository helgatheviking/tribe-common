	...
	public function load_assets() {
		...
		tribe_assets(
			...
			array(
				...
				array( 'tribe-selectWoo', 'vendor/tribe-selectWoo/dist/js/selectWoo.full.min.js', array( 'jquery' ) ),
				array( 'tribe-selectWoo-css', 'vendor/tribe-selectWoo/dist/css/selectWoo.min.css' ),
				...
				array( 'tribe-dropdowns', 'dropdowns.js', array( 'jquery', 'underscore', 'tribe-selectWoo', 'tribe-common' ) ),
		...
		tribe_assets(
			...
			array(
				...
				array( 'tribe-common-admin', 'tribe-common-admin.css', array( 'tribe-dependency-style', 'tribe-bumpdown-css', 'tribe-buttonset-style', 'tribe-selectWoo-css' ) ),
				...
				array( 'tribe-dependency-style', 'dependency.css', array( 'tribe-selectWoo-css' ) ),
